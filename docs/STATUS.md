...
- Final verification is 188 tests passed with 4 strict expected failures, including 71 passing demo
  tests and 101 passing perception tests; Ruff, compilation and git diff --check are clean. The browser runtime
