...
- Final verification is 167 tests passed with 4 strict expected failures, including 70 passing demo
  tests and 81 passing perception tests; Ruff, compilation and git diff --check are clean. The browser runtime
