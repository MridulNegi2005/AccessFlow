...
- Final verification is 178 tests passed with 4 strict expected failures, including 71 passing demo
  tests and 91 passing perception tests; Ruff, compilation and git diff --check are clean. The browser runtime
