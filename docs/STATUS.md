...
- Final verification is 152 tests passed with 4 strict expected failures, including 62 passing demo
  tests and 74 passing perception tests; Ruff, compilation and git diff --check are clean. The browser runtime
