...
- Final verification is 177 tests passed with 4 strict expected failures, including 71 passing demo
  tests and 90 passing perception tests; Ruff, compilation and git diff --check are clean. The browser runtime
