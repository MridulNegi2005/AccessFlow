...
Tests run and results: `uv run --python 3.12 --extra dev pytest -q` — 53 passed; perception run — 31
...
Next independent task: Add held-out speech cases and evaluate an acoustic VAD backend against the timing baseline.
