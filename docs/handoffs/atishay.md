...
Tests run and results: repository virtualenv pytest -q — 187 passed, 4 strict xfailed;
...
perception run — 100 passed; demo run — 71 passed, 4 strict xfailed; contract/engine — 16 passed;
