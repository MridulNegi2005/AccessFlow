...
Tests run and results: uv run --python 3.12 --extra dev pytest -q — 81 passed, 1 strict xfailed;
perception run — 43 passed; demo run — 22 passed, 1 strict xfailed; held-out fixture check included;
