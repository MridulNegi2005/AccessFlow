...
Tests run and results: uv run --python 3.12 --extra dev pytest -q — 81 passed; perception run — 43
passed; demo run — 22 passed; held-out fixture check included; Ruff and git diff --check clean for owned paths.
