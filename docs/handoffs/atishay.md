...
Tests run and results: repository virtualenv pytest -q — 132 passed, 4 strict xfailed;
...
perception run — 58 passed; demo run — 58 passed, 4 strict xfailed; held-out fixture check included;
