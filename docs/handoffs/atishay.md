...
Tests run and results: uv run --python 3.12 --extra dev pytest -q — 83 passed, 1 strict xfailed;
perception run — 43 passed; demo run — 24 passed, 1 strict xfailed; held-out fixture check included;
