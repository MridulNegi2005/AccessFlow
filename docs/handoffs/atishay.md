...
Tests run and results: repository virtualenv pytest -q — 141 passed, 4 strict xfailed;
...
perception run — 66 passed; demo run — 59 passed, 4 strict xfailed; held-out fixture check included;
