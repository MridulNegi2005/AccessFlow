...
Tests run and results: repository virtualenv pytest -q — 225 passed, 4 strict xfailed;
...
perception run — 120 passed; demo run — 89 passed, 4 strict xfailed; contract/engine — 16 passed;
