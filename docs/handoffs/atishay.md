...
Tests run and results: repository virtualenv pytest -q — 221 passed, 4 strict xfailed;
...
perception run — 117 passed; demo run — 88 passed, 4 strict xfailed; contract/engine — 16 passed;
