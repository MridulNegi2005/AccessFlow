...
Tests run and results: repository virtualenv pytest -q — 176 passed, 4 strict xfailed;
...
perception run — 89 passed; demo run — 71 passed, 4 strict xfailed; contract/engine — 16 passed;
...
2026-09-16 verification: Shielded threaded browser media materialization from receiver cancellation and drained active materialization tasks before temporary-session cleanup. Added a focused cancellation regression; full suite: 176 passed, 4 strict xfailed. No protected files changed.
