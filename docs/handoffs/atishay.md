...
Tests run and results: repository virtualenv pytest -q — 175 passed, 4 strict xfailed;
...
perception run — 89 passed; demo run — 70 passed, 4 strict xfailed; contract/engine — 16 passed;
