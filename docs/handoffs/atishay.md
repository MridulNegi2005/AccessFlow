...
Tests run and results: repository virtualenv pytest -q — 124 passed, 4 strict xfailed;
...
perception run — 53 passed; demo run — 55 passed, 4 strict xfailed; held-out fixture check included;
