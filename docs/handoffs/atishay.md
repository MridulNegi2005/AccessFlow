...
Tests run and results: repository virtualenv pytest -q — 121 passed, 4 strict xfailed;
...
perception run — 52 passed; demo run — 53 passed, 4 strict xfailed; held-out fixture check included;
