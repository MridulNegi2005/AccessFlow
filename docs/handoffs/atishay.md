...
Tests run and results: repository virtualenv pytest -q — 167 passed, 4 strict xfailed;
...
perception run — 81 passed; demo run — 70 passed, 4 strict xfailed; contract/engine — 16 passed;
