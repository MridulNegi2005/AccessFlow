...
Tests run and results: repository virtualenv pytest -q — 128 passed, 4 strict xfailed;
...
perception run — 57 passed; demo run — 55 passed, 4 strict xfailed; held-out fixture check included;
