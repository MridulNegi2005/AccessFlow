...
Known failures: Default 3.11 uv target link is broken on this machine; microphone capture, held-out speech-quality ASR, acoustic VAD endpoint quality, vision quality, hosted backend and user feedback evidence are not implemented.
