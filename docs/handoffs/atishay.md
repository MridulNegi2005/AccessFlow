...
Tests run and results: repository virtualenv pytest -q — 231 passed, 4 strict xfailed;
...
perception run — 126 passed; demo run — 89 passed, 4 strict xfailed; contract/engine — 16 passed;
