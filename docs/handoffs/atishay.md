...
Tests run and results: uv run --python 3.12 --extra dev pytest -q — 115 passed, 3 strict xfailed;
...
perception run — 50 passed; demo run — 49 passed, 3 strict xfailed; held-out fixture check included;
