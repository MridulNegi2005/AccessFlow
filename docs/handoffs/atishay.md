...
Tests run and results: `uv run --python 3.12 --extra dev pytest -q` — 78 passed; perception run — 43
passed; demo run — 19 passed; held-out fixture check — 1 passed; Ruff clean for owned paths.
