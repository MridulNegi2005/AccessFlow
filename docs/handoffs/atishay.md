...
Tests run and results: uv run --python 3.12 --extra dev pytest -q — 111 passed, 3 strict xfailed;
...
perception run — 49 passed; demo run — 46 passed, 3 strict xfailed; held-out fixture check included;
