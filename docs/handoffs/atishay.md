...
Tests run and results: repository virtualenv pytest -q — 236 passed, 4 strict xfailed;
...
perception run — 131 passed; demo run — 89 passed, 4 strict xfailed; contract/engine — 16 passed;
