...
Tests run and results: repository virtualenv pytest -q — 252 passed, 4 strict xfailed;
...
perception run — 131 passed; demo run — 105 passed, 4 strict xfailed; contract/engine — 16 passed;
