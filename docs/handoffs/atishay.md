...
Tests run and results: repository virtualenv pytest -q — 188 passed, 4 strict xfailed;
...
perception run — 101 passed; demo run — 71 passed, 4 strict xfailed; contract/engine — 16 passed;
